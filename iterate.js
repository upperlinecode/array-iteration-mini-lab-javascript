...
// 2. Let's expand the dialogue - For each food in the array, print out three lines.
...
// 3a. Now for each food in that array, let's be specific about how MUCH Alex likes it. We'll do this without iteration first.
...
//
// console.log("Alex's #" + (1).toString() + " favorite food is " + favoriteFoods[0])
...
// 5. Now iterate over the array but print out only the even ones.
...
// 7. Now iterate over the array and print out only the names which have more than 6 letters in them.



// 8. Iterate over the array and find the longest name in the whole thing. Then print out "The longest name in the array is ______. It has ___ letters in it."



// 9. Take that same array and sort it into two arrays: one array of long names, which have more than 6 characters, and one array of short names which have 6 or fewer characters. Then print out both arrays.
...
// CHALLENGE: Iterate over the array of numbers to find the average of them all.
